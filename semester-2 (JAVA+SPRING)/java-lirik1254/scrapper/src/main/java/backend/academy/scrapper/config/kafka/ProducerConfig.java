...
public class ProducerConfig {
    ...
    @Bean
    public ProducerFactory<String, UpdateDTO> updateFactory() {
    ...
    @Bean
    public KafkaTemplate<String, UpdateDTO> registrationClientTemplate() {
        return new KafkaTemplate<>(updateFactory());
    }
}
