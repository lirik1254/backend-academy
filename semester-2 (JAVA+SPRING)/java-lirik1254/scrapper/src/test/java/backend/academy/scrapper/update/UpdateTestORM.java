...
import backend.academy.scrapper.utils.ORM.ContentUtilsORM;
...
public class UpdateTestORM extends AddLinkTestsBase {
    protected static WireMockServer wireMockServer;

    @Autowired
    public ContentUtilsORM contentUtilsORM;

    @Autowired
    public LinkRepositoryORM linkRepositoryORM;

    @Autowired
    public UsersRepositoryORM usersRepositoryORM;
    ...
    public void test1() throws Exception {
        ...
        Link link = linkRepositoryORM
                .findByUrlAndChatId("https://github.com/lirik1254/abTestRepo", 123L)
                .getFirst();
        contentUtilsORM.updateContentAndSend(
                link,
    ...
    public void test3() throws Exception {
        ...
        performAddLinkRequest(request, 123L, githubLink, tags, filters);
        User user = usersRepositoryORM.findByChatId(123L);
    ...
    public void test4() throws Exception {
        ...
        assertEquals(Settings.BY_TIME, user.userSettings().notifyMood());
